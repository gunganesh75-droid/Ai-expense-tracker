...
const Analytics = () => {
  ...
  return (
    <DashboardLayout>
      <div className="mb-10">
        <h1 className="text-4xl font-black text-slate-900 tracking-tight mb-2">Spend Analytics</h1>
        <p className="text-slate-500 font-medium">Deep dive into your spending patterns and category distribution.</p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-12">
        <div className="premium-card p-8 group">
          ...
          <p className="text-3xl font-black text-slate-900">{highestSpending}</p>
        </div>
        ...
        <div className="premium-card p-8 group">
          ...
          <p className="text-3xl font-black text-slate-900">{topCategory}</p>
        </div>
      </div>
